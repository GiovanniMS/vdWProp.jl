...
16×2 Array{Any,2}:
 ...
 ?₆₄: 2.1552                     ?₆₄: 2.0395 
 ?₆₄: 0.00039873 K^-1            ?₆₄: 0.0004026 K^-1
 ?₆₄: 2.884e-06 kPa^-1           ?₆₄: 1.4337e-05 kPa^-1
 ?₆₄: 1.3393e-06 kPa^-1          ?₆₄: 7.0439e-06 kPa^-1
 ?₆₄: 1449.1                     ?₆₄: 3276.6 
 "Speed of Sound out of Domain"  𝕍₆₄: 211.16 √kJ/kg
 ?₆₄: 0.028394                   ?₆₄: 0.078088 
...
![plot](./png/f1.png)
```julia
julia> PlotDome([1, 0.6, 0.35, 0.25, 0.18])
...
![plot](./png/f3.png)
```julia
julia> PlotDome([1, 0.4, 0.1, 0.005, 0.0005], true)

```
![plot](./png/f4.png)
```julia
julia> PlotDome(vdWProp.Hg, [1500, 800, 500, 400, 300])
